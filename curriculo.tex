...
\section*{Habilidades}
Python, JavaScript, TypeScript, React, Next.js, Node.js, Nest.js, APIs REST, AWS Lambda, AWS S3, AWS API Gateway, SQL, PostgreSQL, Oracle, MySQL, Git, GitHub, Serverless, Prisma, HTML, CSS, TailwindCSS, SCSS, Docker, Flask, FastAPI, Express, Axios, Redux, PWA, Responsividade, Arquitetura de Software, Microsserviços, CI/CD, Jest, Playwright
